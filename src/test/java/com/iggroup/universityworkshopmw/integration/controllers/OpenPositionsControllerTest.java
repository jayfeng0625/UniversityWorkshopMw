...
public class OpenPositionsControllerTest {
   ...
   public void successfullyGetsOpenPositionsForClient() throws Exception {
      ...
      assertThat(content).isEqualTo("[{\"id\":\"open_position_id\",\"marketId\":\"market_id\",\"profitAndLoss\":1000.0,\"openingPrice\":150.0,\"buySize\":100}]");
      ...
      assertThat(clientId).isEqualTo("client_12345");
   }
   ...
   public void returnsInternalServerErrorForFailedRequest() throws Exception {
      ...
      String content = result.getResponse().getContentAsString();
      assertThat(content).isEqualTo("Something went wrong while getting client positions");
   ...
   public void removesAnOpenPosition() throws Exception {
      ...
      assertThat(content).isEqualTo("1000.0");
   }
